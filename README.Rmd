...
### Deesha's answer
There are r num_heroes Avengers in the dataset, and r num_with_death of them have died at least once.
That means about r round(prop_with_death * 100, 1) % of all Avengers have experienced death.
